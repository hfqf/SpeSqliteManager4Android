...
public class SpeSqliteDatabaseContext extends ContextWrapper {
     ...
     *			上下文环境
     */
    public SpeSqliteDatabaseContext(Context base) {
        super(base);
        this.mContext = base;
    }
    /**
     ...
     * @param dirName
     */
    public SpeSqliteDatabaseContext(Context base, String dirName) {
        super(base);
        this.mContext = base;
